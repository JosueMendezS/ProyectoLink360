...
/**
 * Maneja la conexion a la base de datos. Las credenciales NO van en el
 * codigo: se leen de db.properties (en la raiz del proyecto, junto al
 * pom.xml). Ese archivo no debe subirse al repositorio; se incluye
 * db.properties.example como plantilla.
 */
