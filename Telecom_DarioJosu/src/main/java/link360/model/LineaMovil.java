...
public class LineaMovil {
    ...
    public void setTipoLinea(String v) {
        this.tipoLinea = v;
    }
    ...
    public void setTecnologia(String v) {
        this.tecnologia = v;
    }
    ...
    public void setFechaActivacion(String v) {
        this.fechaActivacion = v;
    }
    ...
    public void setEstadoLinea(String v) {
        this.estadoLinea = v;
    }
    ...
    public void setTipoSIM(String v) {
        this.tipoSIM = v;
    }
