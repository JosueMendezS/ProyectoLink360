...
public class PlanTarifario {
    ...
    public void setCodPlan(String v) {
        this.codPlan = v;
    }
    ...
    public void setCuotaMensual(double v) {
        this.cuotaMensual = v;
    }

    public int getGbIncluidos() {
        return gbIncluidos;
    }

    public void setGbIncluidos(int v) {
        this.gbIncluidos = v;
    }

    public int getMinIncluidos() {
        return minIncluidos;
    }

    public void setMinIncluidos(int v) {
        this.minIncluidos = v;
    }

    public int getMsgIncluidos() {
        return msgIncluidos;
    }

    public void setMsgIncluidos(int v) {
        this.msgIncluidos = v;
    }
    ...
    public void setCostoExceso(double v) {
        this.costoExceso = v;
    }
