...
public class Factura {
    ...
    public void setNumFactura(int v) {
        this.numFactura = v;
    }
    ...
    public void setNumTelefonico(String v) {
        this.numTelefonico = v;
    }
    ...
    public void setFechaVencimiento(String v) {
    ...
    public void setImpuestos(double v) {
        this.impuestos = v;
    }
    ...
    public void setDescuentosAplicados(double v) {
        this.descuentosAplicados = v;
    }
    ...
    public void setPuntosRedimidos(int v) {
        this.puntosRedimidos = v;
    }
    ...
    public void setMontoFinal(double v) {
        this.montoFinal = v;
    }
    ...
    public void setFechaPago(String v) {
        this.fechaPago = v;
    }
    ...
    public void setEstadoPago(String v) {
        this.estadoPago = v;
    }
